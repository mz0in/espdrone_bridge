#ifndef INCLUDE_aerial_catcher_PARAMETERS_H_
#define INCLUDE_aerial_catcher_PARAMETERS_H_
...
static constexpr double kDefaultMass = 1.56779;//1.56779  1.72
...
#endif /* INCLUDE_aerial_catcher_PARAMETERS_H_ */
