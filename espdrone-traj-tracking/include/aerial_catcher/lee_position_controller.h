...
#ifndef aerial_catcher_LEE_POSITION_CONTROLLER_H
#define aerial_catcher_LEE_POSITION_CONTROLLER_H
...
namespace aerial_catcher
{
  ...
  public:
    ...
    void CalculateRPYT(Eigen::VectorXd *rpyt) const;
...
#endif // aerial_catcher_LEE_POSITION_CONTROLLER_H
