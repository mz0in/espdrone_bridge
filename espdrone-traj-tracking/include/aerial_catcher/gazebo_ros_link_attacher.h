...
#include "aerial_catcher/Attach.h"
#include "aerial_catcher/AttachRequest.h"
#include "aerial_catcher/AttachResponse.h"
...
namespace gazebo
{
   ...
   private:
        ...
        bool attach_callback(aerial_catcher::Attach::Request &req,
                              aerial_catcher::Attach::Response &res);
        bool detach_callback(aerial_catcher::Attach::Request &req,
                             aerial_catcher::Attach::Response &res);
